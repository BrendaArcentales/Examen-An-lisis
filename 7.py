#pip install pymonog[srv]
import couchdb
import requests
from pymongo import MongoClient
#Conexion a couchDb
URL = 'http://admin:brenda@localhost:5984/'
try:
...
#Conexion a mongodb
CLIENT = MongoClient("mongodb+srv://Examen:examen@cluster0.60gzs.mongodb.net/Twiter?retryWrites=true&w=majority") #Indicarparametrosdel servidor
try:
...
DBS = CLIENT.get_database('Twiter-Couch')
